...
describe('{{imgix}} helper', function () {
    var logWarnStub;
    ...
    it('should output relative url of image', function () {
        var rendered = helpers.imgix_url('/content/images/image-relative-url.png', {});
    ...
    it('should output absolute url of image if the option is present ', function () {
        var rendered = helpers.imgix_url('/content/images/image-relative-url.png', {hash: {absolute: 'true'}});
        should.exist(rendered);
    ...
    it('should output author url', function () {
        var rendered = helpers.imgix_url('/content/images/author-image-relative-url.png', {});
        should.exist(rendered);
    ...
    it('should have no output if the image attributeis not provided (with warning)', function () {
        var rendered = helpers.imgix_url({hash: {absolute: 'true'}});
    ...
    it('should have no output if the image attribute evaluates to undefined (with warning)', function () {
        var rendered = helpers.imgix_url(undefined, {hash: {absolute: 'true'}});
        should.not.exist(rendered);
        logWarnStub.calledOnce.should.be.true();
    });

    it('should have no output if the image attribute evaluates to null (no waring)', function () {
        var rendered = helpers.imgix_url(null, {hash: {absolute: 'true'}});
        should.not.exist(rendered);
    ...
    describe('with sub-directory', function () {
        ...
        it('should output relative url of image', function () {
            var rendered = helpers.imgix_url('/blog/content/images/image-relative-url.png', {});
            should.exist(rendered);
            rendered.should.equal('/blog/content/images/image-relative-url.png');
        });

        it('should output absolute url of image if the option is present ', function () {
            var rendered = helpers.imgix_url('/blog/content/images/image-relative-url.png', {hash: {absolute: 'true'}});
            should.exist(rendered);
        ...
        it('should not change output for an external url', function () {
            var rendered = helpers.imgix_url('http://example.com/picture.jpg', {});
            should.exist(rendered);
